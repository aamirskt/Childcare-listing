...
const MarketPlaceWelcomeSecreen: React.FC<DeleteChildrenModalProps> = ({ open, onClose, setMarketPlacePopup, setWelcomePopup }) => {
    ...
    return (
        <>
            ...
            <Grid container alignItems={'center'} pt={'60px'}>
                <Grid
                    item
                    xs={12}
                    md={4}
                    sx={{
                        ...
                        // height:{md:'570px'},
                        // height:'100%',
                        minHeight: { xs: '270px', md: '90vh', }, position: 'relative'
                    }}
                >
                ...
                {!smartSearch ?
                    <>
                        <Grid item xs={12} md={8} sx={{ pl: { xs: 2, md: 4 }, color: '#252B42' }} margin={'auto'} display={'flex'} justifyContent={'center'}>
                            <Stack sx={{ mr: 2, py: 0, width: '530px' }}>
                                <Box display="none" alignContent="center" justifyContent={'center'} mb={2}>
                                    {
                                        <Stack
                                            flexDirection="row"
...
export default MarketPlaceWelcomeSecreen;

...
import NewSectionSeven from '../home/NewSectionSevenDynamic';
...
const SearchDayCares = ({ abr, daycares, zipcode, aiData, allblogs, topCities }: SearchProps) => {
    ...
    return (
        <Stack sx={{ backgroundColor: '#fff' }}>
            ...
            <Grid container sx={{
                mt: !isLoading && ShowCenterDetails ? 0 : !isSimpleSearch ? '80px' : '0px',

            }}>
                <Grid item xs={12} >

                    {isDetailsModalOpen && <DetailPageMobileView onClose={handleCloseDetailsModal} id={dayCareslistbyId?.id} isMarketPlace={true} />}

                    {marketPlacePopup ? <MarketPlaceMobileComp
                        ...
                        isModalOpen1 ?
                            ...
                            !isLoading && ShowCenterDetails ? (
                                ...
                                >
                                    ...
                                    >
                                        <Stack sx={{ width: '100%', display: 'flex', justifyContent: 'flex-end', p: '16px 16px 0px 0px', }}>
                                            <button
                                                onClick={handleClose}
                                                style={{
                                                    background: '#fff',
                                        ...
                                        <Stack
                                            ...
                                            <IconButton
                                                sx={{
                                                    width: '53px',
                                                    height: '28px',
                                                    top: '-9px', // place it just below the Stack
                                                    left: '50%',
                                            ...
                                            >
                                                {!daycareList ?
                                                    <Stack
                                                        sx={{
                                                            borderRadius: '6px',
                                                            height: windowSize.innerHeight - 200,   //here for mobile screen heigh
                                                            maxHeight: windowSize.innerHeight - 200,
                                                        }}
                                                    >
                                                        {!isLoading ? <Stack
                                                            sx={{
                                                        ...
                                                        >
                                                            ...
                                                            <GoogleMap
                                                                mapContainerStyle={{
                                                                    ...
                                                                    height: window.innerHeight - 200,  //here for mobile screen heigh
                                                                    width: !open ? '100%' : 'auto',
                                                                    backgroundColor: '#F2F2F2', border: '2px sodlid #000',
                                                                    boxShadow: "16px",
                                                ...
                                                > */}
                                                        {Array.isArray(filteredData) && <Box
                                                            sx={{
                                                                display: 'flex',
                                                                flexDirection: 'column',
                                                                    ...
                                                                    filteredData?.map((item: any, ind: any) => (
                                                                        <Stack key={ind}>
                                                                            <Box
                                                                                ...
                                                                                sx={{
                                                                                    backgroundColor: selectedCenter == ind ? '#F8F9FA' : '#F2F2F2',
            ...
            >
                ...
                {!/^\d+$/.test(`${zipcod}`) && <Container sx={{ my: 5 }}>
                    <Grid container spacing={2}>
                        ...
                        {aiAboutCity && <Grid item xs={12} md={12}>

...
const SearchDayCares = ({ abr, daycares, zipcode, aiData, allblogs, topCities }: SearchProps) => {
    ...
    return (
        <Stack sx={{ backgroundColor: '#fff' }}>
            ...
            <Grid container sx={{
                mt: !isLoading && ShowCenterDetails ? 0 : !isSimpleSearch ? '80px' : '61px',
                    ...
                    <Grid container spacing={2}>
                        ...
                        {aiAboutCity && <Grid item xs={12} md={12}>
                            ...
                            <Stack >
                              ...
                              {!/^\d+$/.test(`${zipcod}`) && topCities.length !== 0 && <NewSeoSection1 topCities={topCities} category={category} statecode={daycares} cityname={zipcode} />}

            ...
            /> :
                <>
                    ...
                    <Grid container sx={{
                        ...
                        <Stack sx={{ mt: { xs: 4, md: 0 }, width: '100%', position: 'absolute', zIndex: isModalOpen1 && smallScreen ? 0 : 2, p: { xs: '20px 12px', md: 0 } }}>
                            <Grid
                                container
                                // spacing={2}
                                sx={{

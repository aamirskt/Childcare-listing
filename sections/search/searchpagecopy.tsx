...
import MarketPlaceWelcomeSecreen from 'components/MarketplaceWelcomeScreen';
...
const SearchDayCares = ({ abr, daycares, zipcode }: SearchProps) => {
    ...
    return (
        <Stack>
            <ReloadOnBack />
            {isLoading && !welcomePopup && <LoadingComp loading={isLoading} />}
            {welcomePopup && !mdScreen ? <MarketPlaceWelcomeSecreen open={welcomePopup} onClose={handleWelcomePopup} setMarketPlacePopup={setMarketPlacePopup} setWelcomePopup={setWelcomePopup} /> : marketPlacePopup && !mdScreen ? <MarketplacenModalScreen sliderRatio={sliderRatio}
                graphData={graphData}

...
import MarketplacenModalScreen from 'components/MarketPlaceSliderScreen';
    ...
    return (
        <Stack>
            ...
            >
                ...
                {!/^\d+$/.test(`${zipcod}`) && <Container sx={{ my: 5 }}>
                    <Grid container spacing={2}>
                        <Grid item xs={12} md={aiAboutCity ? 12 : 12}>
                            ...
                            <Stack>
                                <Typography variant="sectiontitle" sx={{ fontSize: '20px' }}>UseFul Information</Typography>
                                                ...
                                                getListOfTagsTextFromString(categoryContent, /<(h[2-4])>([^<>]+)<\/\1>/g, /<\/?h2>/g).map((_item: any, index: any) => {
                                                    ...
                                                    return (
                                                        <Stack>
                                                            <h2>
                                                                {' '}
                                                                <Typography sx={{ fontSize: '16px', fontWeight: 600 }} dangerouslySetInnerHTML={{ __html: _item }} />
                                                            </h2>
                                                            {categoryContent && (
                                                                <Typography
                                                                    sx={{ fontSize: '14px' }}
                        ...
                        {aiAboutCity && <Grid item xs={12} md={12}>
                            ...
                            <Stack >
                                <Typography variant="sectiontitle" sx={{ fontSize: '20px' }}>About City</Typography>
                ...
                {category && <NewSeoSection1 category={category} statecode={daycares} cityname={zipcode}/>}
                <BlogsSectionSeo abr={category} />
